...
public class SwaggerConfiguration {
	@Bean
	public Docket api() { // Docket é o nome da classe que utiliza para montar a documentacao
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfo("API para Cadastro de Pessoas", "Sistema Spring Boot API / Hibernate JPA", "Versão 1.0",
				...
				new Contact("members", "http://www.jotabelk.com.br", "contato@joltabelk.com.br"), "Licença da API",
				"http://www.jotabelk.com.br", Collections.emptyList());
	}
